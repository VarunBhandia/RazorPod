...
function lname(){
  ...
  'Zamora',
  'Zimmerman']
	let number = Math.random() * lnames.length;
	return lnames[Math.floor(number)];
}
...
function generateEmail(fname, lname){
	...
	if (location.href === AMNZREG){
		...
		F1("ap_customer_name", fname1 +" "+ lname1);
		F1("ap_email", generateEmail(fname1, lname1));
		F1("ap_password", "qwerty@123");
		F1("ap_password_check", "qwerty@123");
		document.getElementById("continue").click(); 
	} 


if (location.href === NEWUSERURL || location.href === NEWUSERURL2){
	chrome.runtime.sendMessage({ stage: 2 })
}

//if(location.href === SKILL1URL){
//	document.getElementById("a2s-skill-enable-button").click();
//	chrome.runtime.sendMessage({ stage: 2 })
//}

if(location.href === SKILL1URL){
	document.getElementById("a2s-skill-enable-button").click();
	chrome.runtime.sendMessage({ stage: 3 })
}

if(location.href.substring(0,35) === "https://na.account.amazon.com/ap/oa"){
	
	document.getElementsByName("consentApproved")[0].click();
}

if(location.href.substring(0,44) === "https://alexa-voice-service-setup.amazon.com"){
